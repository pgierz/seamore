...
class GlobalAttributesTests < Minitest::Test
  ...
  def test_global_attributes_for_variable_so_have_variable_id_so
    ...
    builder.set_experiment_info(id: "highres-future", variant_label: "r1i1p1f002", first_year: 2000, last_year: 2000)
    builder.set_parent_experiment_info(id: "control", variant_label: "r1i1p1f002", first_year: 1900, last_year: 2000)
